...
\newcommand{\mloosegap}{\metaref{LooseGap}}
\newcommand{\mstrictgap}{\metaref{StrictGap}}
...
\paragraph{Strict gaps}

A \mstrictgap{} contains nothing.
\todo{Perhaps a strict gap can just be a loose gap with the allowed set held
empty.  The current semantics of an empty allowed set (= universal set) doesn't
permit this, though.}
...
the universe \todo{this is somewhat inelegant, and prevents us unifying the
two types of gap}.
