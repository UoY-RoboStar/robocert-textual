...
\tikzset{
  ...
  lifeline/.style={thick, color=ocre!50},
  ...
  final/.style={thick, dashed, font={\scriptsize\gkeywordfont}, "end"},
  wait/.style={thick, dashed, font={\scriptsize}},
  cfbox/.style={draw},
...
\newcommand{\gdeadline}[3]{
  ...
  \draw ($(#1) + (\gdeadlineoffset, 0)$) edge[deadlinespan,"\{0..#3\}"] ($(#2) + (\gdeadlineoffset, 0)$);
