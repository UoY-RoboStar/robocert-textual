...
discussed in \cref{sec:semantics-comparison-review-seq}, this
...
The semantics of a
\msequenceproperty{} relates the \msequence{} of the assertion to the
...
The definitions here correspond to \cref{sec:seq-metamodel-steps}.
...
The definitions here correspond to \cref{sec:seq-metamodel-actions}.
...
float,
language=RoboCert,
label={lst:semantics-tockcsp-seq-example},
caption={Worked example for the \tockcsp{} sequence semantics.}
]{examples/segway/tockcsp.rcert}

Consider the \langname{} script in
\cref{lst:semantics-tockcsp-seq-example}.  This script contains a
\msequenceproperty, \texttt{G1}, which we can translate to \tockcsp{} as follows:
