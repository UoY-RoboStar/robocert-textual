...
/**
 * A lifeline context that represents the situation while generating the body of a sequential process.
 *
 * <p>
...
public record SequentialContext(InteractionContext global) implements LifelineContext {
    ...
    @Override
    public <T> T handleSequential(SequentialFragment f, Function<SequentialFragment, T> emitInline, Function<Integer, T> emitReference) {
