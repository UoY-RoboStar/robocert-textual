...
class ImplicitEdgeImplCustom extends ImplicitEdgeImpl {
  ...
  /**
   * Gets the system module target lifeline of this edge's enclosing sequence if its direction is
   * equal to the given direction, and the context otherwise.
   *
  ...
  private Actor getContextOrModuleIf(EdgeDirection direction) {
    ...
    final var grp = EcoreUtil2.getContainerOfType(this, SpecificationGroup.class);
