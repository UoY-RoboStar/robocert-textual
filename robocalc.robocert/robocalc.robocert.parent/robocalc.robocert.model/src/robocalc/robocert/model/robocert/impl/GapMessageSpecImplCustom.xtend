...
import robocalc.robocert.model.robocert.impl.GapMessageSpecImpl
import robocalc.robocert.model.robocert.MessageDirection
import org.eclipse.xtext.EcoreUtil2
import robocalc.robocert.model.robocert.SequenceGroup

/**
 * Inserts actor-seeking functionality into GapMessageSpecImpl.
 */
class GapMessageSpecImplCustom extends GapMessageSpecImpl {
	// TODO(@MattWindsor91): find a way of deduplicating the bits of this that
	// are common with ArrowMessageSpecImplCustom.
