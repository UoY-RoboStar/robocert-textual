 ...
 *
 * Specification groups that contain targets have a regular structure,
 * where the target's parametrisation is exposed in both 'closed' and 'open'
 * forms, along with its tick-tock context. 
 *
...
public enum SpecGroupField {
	...
	PARAMETRIC_OPEN,
	/**
	 * The module instance in the group providing its context for tick-tock module
	 * shifting.
	 */
	TICK_TOCK_CONTEXT,
