...
class TargetGenerator {
	 ...
	 */
	def dispatch CharSequence generate(RCModuleTarget tgt) // TODO: move this and the import logic into the same place.
	...
	def dispatch CharSequence generate(Target tgt) '''{- UNSUPPORTED TARGET: «tgt» -} STOP'''
}
