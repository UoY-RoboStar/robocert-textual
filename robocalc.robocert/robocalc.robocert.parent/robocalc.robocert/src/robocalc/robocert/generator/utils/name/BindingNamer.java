...
public class BindingNamer {
  /**
   * Produces an unambiguous name for a binding within its notational container.
   *
   * <p>Names generated by this method are long, systematic, sensitive to changes in the metamodel,
   * and not guaranteed to be particularly human-readable, but should theoretically be unique within
   * the container.
   *
